...
**Status.** Release-candidate track (currently `v1.0.0-rc5`). rc5 is
the release-boundary candidate after downstream `v1.0.0-rc4`
validation surfaced issues #84 through #103. The public contract
