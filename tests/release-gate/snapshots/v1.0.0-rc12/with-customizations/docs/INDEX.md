...
For the broader downstream ownership model — framework-managed files
vs project-owned product files vs project-filled registers — see
[`framework-project-boundary.md`](framework-project-boundary.md).
