...
**Purpose**: Customer sign-off unlocks v1.2.0 and v1.3.0 implementation entry per Q-0025 + addendum (FR-011 / SC-007).
...
- [X] T038 [US3] Close Q-0025 in `sw-dev-team-template/docs/OPEN_QUESTIONS.md` Resolution column with a pointer to the CUSTOMER_NOTES sign-off entry. **Closed 2026-05-28:** Q-0025 row updated with closeout note + spec 016 pointers.
...
- [X] T040 [P] Update the GitHub issues: close #239 and #245 with a pointer to the merged design-pass commit set and the customer sign-off date. **Done (pointers recorded).**
...
- [X] T042 Mark spec 016 `Status: Complete` in `specs/016-token-economy-design/spec.md` after PR merges. **Done.**
