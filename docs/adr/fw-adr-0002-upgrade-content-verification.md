...
- [Considered options (Three-Path Rule, binding)](#considered-options-three-path-rule-binding)
  - [Option M — Minimalist: on-demand re-fetch + per-file diff](#option-m--minimalist-on-demand-re-fetch--per-file-diff)
  - [Option S — Scalable: hash manifest at scaffold/upgrade](#option-s--scalable-hash-manifest-at-scaffoldupgrade)
  - [Option C — Creative: content-addressed shipping (no separate version)](#option-c--creative-content-addressed-shipping-no-separate-version)
- [Decision outcome](#decision-outcome)
  - [Interface decisions (binding)](#interface-decisions-binding)
  - [Migration `migrations/v0.14.0.sh` design](#migration-migrationsv0140sh-design)
