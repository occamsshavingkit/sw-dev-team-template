...
**Final disposition**: 35/35 closed; fixed 31, wontfix 1 (#59), v2-deferred
3 (#3, #27, #145), consolidated 0, duplicate 0, customer-blocked open 0;
#189 closed via PR #252.
...
|---|---:|---|---|
| **Fixed** | 31 | Fix-and-close PRs #204–#258 | Direct problem resolution (code, docs, tests), including #189 via PR #252 |
...
| **Customer-blocked open** | 0 | PR #252 | #189 closed via PR #252 after Q-0014 ruling |
| **TOTAL** | 35 | | |
...
- Baseline progress: 35/35 closed after #189 closed via PR #252
...
**Open blockers**: none; #189 closed via PR #252.
...
- **31 issues fixed** via direct problem resolution (code, tests, docs), including
  #189 closed via PR #252
...
- **3 issues added to v2 roadmap** (#3, #27, #145) with explicit customer
  acknowledgment
- **0 issues remain customer-blocked open**; consolidated and duplicate counts are
  both 0.
