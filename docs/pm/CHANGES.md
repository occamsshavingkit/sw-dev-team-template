...
| C-14 | 2026-05-12 | `project-manager` | Record M3-M9 framework/project boundary handling for template and downstream-reference work before implementation dispatch. | Scope / quality / process | Treats M3-M7 and M9 as framework/template-maintenance, M8 as downstream-reference rollout evidence, and forbids mixing downstream product edits with template changes unless explicitly authorized. | `project-manager` within PM artifact scope | Approved | 2026-05-12 | Supports `specs/003-remaining-milestones/tasks.md` T006. Template edits stay in framework-managed paths; downstream reference work records classification, repair sequence, repaired-or-excepted status, and exceptions without product edits in this planning slice. |
...
- C-14: `docs/pm/SCHEDULE.md`; `docs/pm/LESSONS.md`;
  `specs/003-remaining-milestones/tasks.md` T004-T007.
