...
| C-11 | 2026-05-04 | `release-engineer` | Prepare in-tree `v1.0.0-rc7` candidate files for issue #116 concise specialist briefs and the no-full-context-fork rule. | Scope / schedule / quality | Moves rc7 from draft planning to release-candidate state without claiming final readiness; Claude Code validation evidence remains pending for final. | Customer task authorization | Approved | 2026-05-04 | Updates `VERSION`, `CHANGELOG.md`, `README.md`, `ROADMAP.md`, and `docs/v1.0.0-final-checklist.md`; `v1.0.0-rc7` is tag-only and has no GitHub Release object. |
...
| C-13 | 2026-05-04 | `tech-lead` / customer clarification | Clarify that Claude Code + Codex validation for issue #116 is required for `v1.0.0` final, not for tagging the rc7 release candidate. | Quality / release governance | Removes an accidental rc7 tag blocker while preserving the final parity gate. | Customer direct ruling | Approved | 2026-05-04 | Updates `CHANGELOG.md`; `docs/v1.0.0-final-checklist.md` G-11 remains pending for final readiness. |
| C-14 | 2026-05-26 | `project-manager` | Prepare v1.0.0-rc15 active candidate files and update final-readiness checklist gates. | Quality / release governance | Aligns checklist, roadmap, and release-notes to rc15 and marks G-1, G-2, G-4, and G-11 as Green/Passed. | Customer task authorization and attestation | Approved | 2026-05-26 | Updates `sw-dev-team-template/docs/v1.0.0-final-checklist.md`, `ROADMAP.md`, `docs/v1.0.0-release-notes.md`, and `CUSTOMER_NOTES.md`. |
| C-15 | 2026-05-27 | `project-manager` | Correct rc14 baseline burndown closure records to final disposition: 35/35 closed; fixed 31, wontfix 1 (#59), v2-deferred 3 (#3, #27, #145), consolidated 0, duplicate 0, customer-blocked open 0; #189 closed via PR #252. | Quality / release governance | Corrects release-prep evidence without changing rc14 scope or tag state; records 22 new-finding fan-out issues for rc15 intake. | `tech-lead` dispatch | Approved | 2026-05-27 | Updates `sw-dev-team-template/CHANGELOG.md`, `sw-dev-team-template/docs/pm/burndown-rc13-rc14-summary.md`, and `specs/011-issue-backlog-triage/tasks.md`; source: `sw-dev-team-template/docs/pm/dispatch-log.md` T047/T049. |
...
- C-13: `CHANGELOG.md`; `docs/v1.0.0-final-checklist.md` remains the
  final-readiness source of truth.
- C-14: `docs/v1.0.0-final-checklist.md`; `ROADMAP.md`; `docs/v1.0.0-release-notes.md`; `CUSTOMER_NOTES.md`.
- C-15: `sw-dev-team-template/CHANGELOG.md`;
  `sw-dev-team-template/docs/pm/burndown-rc13-rc14-summary.md`;
  `specs/011-issue-backlog-triage/tasks.md`.
