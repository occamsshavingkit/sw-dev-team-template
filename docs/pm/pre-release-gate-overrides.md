...
|------|------|------------|------------|----------|--------|-------------------------------|
| 2026-05-26 | pre-bootstrap | (pre-bootstrap) | | occamsshavingkit@gmail.com | local-edit:scripts/upgrade.sh (unspecified) | |
| 2026-05-26 | pre-bootstrap | (pre-bootstrap) | | occamsshavingkit@gmail.com | local-edit:scripts/lib/semver.sh (unspecified) | |
