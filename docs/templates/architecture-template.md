...
catalog and rationale). Sections marked **omit** must be replaced with
"omitted; rationale: …" — never silently dropped.
...
| § 5.5 Dependency | § 6 dependency diagram + § 9 cross-cutting |
| § 5.6 Information | § 9 cross-cutting (data-model subsection) |
| § 5.7 Patterns use | § 4 Solution strategy |
| § 5.8 Interface | § 5 / § 6 (interface subsections) |
| § 5.9 Structure | § 6 Component view |
| § 5.10 Interaction | § 7 Runtime view |
| § 5.11 State dynamics | § 7 Runtime view (state-transition subsection) |
| § 5.12 Algorithm | embedded in ADRs (`docs/adr/`) |
| § 5.13 Resource | § 8 Deployment view |
