...
Rationale, examples, routing detail, parallelism guidance, dispatch
discipline rules, memory-first lookup, scoping-transcript dump,
design-intent tie-break, and agent-health/respawn procedure live in
the manual: `docs/agents/manual/tech-lead-manual.md`. The sections
below are the schema-allowlisted canonical contract.
